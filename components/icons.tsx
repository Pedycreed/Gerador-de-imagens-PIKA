...
export const PikaIcon: React.FC = () => (
    <svg
      width="28"
      height="28"
      viewBox="0 0 24 24"
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg
        ...
        className={className}
    >
        <path d="M9.9 2.1c.2-.5.8-.5 1 0l1.2 3 3 1.2c.5.2.5.8 0 1l-3 1.2-1.2 3c-.2.5-.8.5-1 0l-1.2-3-3-1.2c-.5-.2-.5-.8 0-1l3-1.2L9.9 2.1z" />
        <path d="M21 11c.2-.5.8-.5 1 0l.6 1.5 1.5.6c.5.2.5.8 0 1l-1.5.6-.6 1.5c-.2.5-.8.5-1 0l-.6-1.5-1.5-.6c-.5-.2-.5-.8 0-1l1.5-.6.6-1.5z" />
        <path d="m3 7 .6 1.5 1.5.6c.5.2.5.8 0 1l-1.5.6-.6 1.5c-.2.5-.8.5-1 0l-.6-1.5-1.5-.6c-.5-.2-.5-.8 0-1l1.5-.6.6-1.5c.2-.5.8-.5 1 0z" />
    </svg>
);
